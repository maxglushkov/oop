...
bool TestGearLowerBound(Car & car, int gear, int lowerBound)
{
	return AND(
...
bool TestGearUpperBound(Car & car, int gear, int upperBound)
{
	return AND(
...
TEST_CASE("Default car state")
{
	...
	REQUIRE(car.GetDirection() == Direction1D::None);
